...
- [ ] CF-004 | SPECS | import ~/.zsh_history into the dropdown as whole-line recall (recency-ranked, max defaulted high) | STATUS=OPEN | reported_by=jeportie | GH=n/a (issues disabled)
